...
instance B.Bytable EcPointFormat where
	...
	encode (EPFRaw epf) = BS.pack [epf]
	decode bs = case BS.unpack bs of
		[epf] -> Right $ case epf of
			0 -> EPFUncompressed; _ -> EPFRaw epf
		_ -> Left "Extension.decodeEPF"
