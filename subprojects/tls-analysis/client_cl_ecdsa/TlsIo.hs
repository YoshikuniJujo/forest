...
encryptMessage partner ct v msg = do
	(version, cs, mwk, sn, mmk) <- getParameters partner
...
getParameters :: Partner -> TlsIo cnt (Maybe CT.MSVersion,
	CipherSuite, Maybe BS.ByteString, Word64, Maybe BS.ByteString)
